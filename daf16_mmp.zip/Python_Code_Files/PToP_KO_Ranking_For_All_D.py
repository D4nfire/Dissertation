...
def runRanking(connectionFilePath, expressionFilePath, koGene, graphFile, outputFile, d, geneAndAllRankingsList, testCount, countPerGene):
...
def main(connectionFilePath, expressionFilePath, koGene, graphFile, outputFile, geneAndAllRankingsList, testCount, countPerGene):
	...
	i = 0.0
	while (i <= 1.02):
		geneAndAllRankingsList, testCount, countPerGene = runRanking(connectionFilePath, expressionFilePath, koGene, graphFile, outputFile, i, geneAndAllRankingsList, testCount, 0);
		i = i + 0.05

# Call to write the header to the file PToPRankings.txt	
...
while (i < num):
	...
	testCount = 0
	countPerGene = 0
	main(geneConnectionPath + testGeneList[i] + endOfConnectionPath, geneExprPath + testGeneList[i] + endOfExprPath, testGeneList[i], testGeneList[i] + graphPath, "PToPRankings.txt", geneAndAllRankingsList, testCount, countPerGene);
	i = i + 1